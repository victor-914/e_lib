      ...
      <div className="w-full flex flex-wrap  justify-evenly  h-screen">
        {Chapter.map((chapter) => (
          <Link href={`/resource/${chapter.name}`}>
            <li className="chapterContainer  flex justify-center items-center w-4/5 h-20 rounded shadow-lg bg-slate-200 list-none uppercase text-center mt-4 hover:shadow-lg hover:bg-green-700 hover:text-white">
